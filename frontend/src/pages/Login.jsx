    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 animate-fade-in">
            <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg rounded-xl w-full max-w-md animate-slide-up">
                <h3 className="text-2xl font-bold text-center text-gray-800 animate-pop">Login to Account</h3>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-baseline justify-between animate-slide-up" style={{ animationDelay: '300ms' }}>
                        <button className="px-6 py-3 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-700 w-full font-bold transition-all duration-300 shadow-md transform hover:-translate-y-1 active:scale-95">Login</button>
                    </div>
                    <div className="mt-6 text-center animate-fade-in" style={{ animationDelay: '400ms' }}>
                        <a href="/register" className="text-sm text-blue-600 hover:underline">Don't have an account? Sign up</a>
                    </div>
                </form>
            </div>
        </div>
